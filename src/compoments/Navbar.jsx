        ...
        <div className='flex md:hidden justify-between px-4'>
          <div href="/" className="text-primary  flex gap-1 items-center">
            ...
            <h1 className='text-red-500 font-bold text-xl '>
              Spicy
              <span className="text-gray-800 font-semibold">Dishes</span>
            </h1>
          </div>
        ...
        <div className='hidden md:flex justify-between items-center px-10 '>
          ...
          <div className='flex items-center gap-x-6'>
            ...
            <ul className="flex items-center cursor-pointer gap-8 text-black font-semibold">
              <li> <a href='#' className='hover:text-red-500 transition-all'>Home</a></li>
              ...
              <button className='bg-red-500 px-4 py-2 text-white rounded-lg  hover:bg-red-600 hover:scale-110 transition-all'>Order Now</button>
            </ul>
          </div>
        </div>
      </div>
